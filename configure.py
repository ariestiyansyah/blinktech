...
settings.configure(DEBUG=True, TEMPLATE_DEBUG=True,
    TEMPLATE_DIRS=(os.path.join(BASE_DIR, 'blink_web'),)
)
...
UPDATE django_site SET DOMAIN = '0.0.0.0:8000', name = 'blink_web' WHERE id=1;
...
#settings_template = Template(open("blink_web/settings.template.py").read())
...
if __name__ == "__main__":
    ...
    with open('blink_web/settings_generated.py', 'w') as out:
